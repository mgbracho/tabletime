...
export function HouseholdView() {
  ...
  if (loading) return <p className="text-sm text-zinc-500">Cargando perfiles…</p>;
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border-l-4 border-l-teal-600 border border-teal-200 bg-teal-50/60 p-4">
        ...
        <p className="mb-3 text-xs text-zinc-600">
          Pulsa «Generar enlace de invitación» y comparte el enlace con quien quieras que se una. El enlace caduca en 7 días.
        </p>
        {!inviteLink ? (
          <button
            type="button"
            ...
            onClick={async () => {
              ...
              try {
                ...
                setInviteLink(res.ok && data.link ? data.link : "Error al generar el enlace");
              } catch {
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                const data = await res.json();
                setShareLink(res.ok && data.link ? data.link : "Error al generar el enlace");
              } catch {
      ...
      <div className="rounded-xl border-l-4 border-l-amber-600 border border-teal-200 bg-amber-50/60 p-4">
        ...
        <p className="mb-2 text-xs text-zinc-500">
          Para añadir más personas que usan la app, usa el bloque «Añadir miembros al hogar» de arriba.
        </p>
        <p className="mb-2 text-xs text-zinc-500">
